...
# with the test data. When logged in as the author, there should be a link
# to edit the post.
...
# delete, otherwise a 403 Forbidden status is returned
...
def test_search(client, auth):
    response = client.post('/search', data={'nmHiddenSearchFormInput': 'test'})
...
# should insert the new post data into the database, and update should
# modify the existing data. Both pages should show an error message on
# invalid data.
